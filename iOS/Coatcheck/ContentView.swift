...
struct ContentView: View {
    ...
    @State private var editingItem: Fee?
    ...
    private func amountText(_ item: Fee) -> String? {
...
struct EntryFormView: View {
    ...
    let mode: FormMode
    @State private var draft: Fee

    init(mode: FormMode) {
        self.mode = mode
        switch mode {
        case .add:
            _draft = State(initialValue: Fee())
        case .edit(let item):
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    TextField("FeeType", text: $draft.feeType)
                        .accessibilityIdentifier("field_feeType")
