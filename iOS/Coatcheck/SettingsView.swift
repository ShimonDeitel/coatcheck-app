    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/coatcheck-app/privacy.html")!)
                        .accessibilityIdentifier("privacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/coatcheck-app/terms.html")!)
